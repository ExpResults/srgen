...
TRAIN_IN=${ROOT}/data/input/train-allpos-alldep-dir95.depl

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-allpos-alldep-dir95.depl

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-allpos-alldep-dir95.depl

SIG=`date '+%Y-%m-%d-%H%M%S'`-labeled-topdown-constrain-dir95
