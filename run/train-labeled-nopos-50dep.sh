...
TRAIN_IN=${ROOT}/data/input/train-nopos-50dep.depl

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-nopos-50dep.depl

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-nopos-50dep.depl

SIG=`date '+%Y-%m-%d-%H%M%S'`-labeled-nopos-50dep
