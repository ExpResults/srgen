...
TRAIN_IN=${ROOT}/data/input/train-nopos-alldep.depl

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-nopos-alldep.depl

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-nopos-alldep.depl

SIG=`date '+%Y-%m-%d-%H%M%S'`-labeled-nopos-alldep
