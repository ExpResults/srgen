...
TRAIN_IN=${ROOT}/data/input/train-nopos-50dep.dep

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-nopos-50dep.dep

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-nopos-50dep.dep

SIG=`date '+%Y-%m-%d-%H%M%S'`-unlabeled-nopos-50dep
