...
TRAIN_IN=${ROOT}/data/input/train-50pos-nodep.dep

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-50pos-nodep.dep

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-50pos-nodep.dep

SIG=`date '+%Y-%m-%d-%H%M%S'`-unlabeled-50pos-nodep
