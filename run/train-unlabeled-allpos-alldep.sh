...
TRAIN_IN=${ROOT}/data/input/train-allpos-alldep.dep

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-allpos-alldep.dep

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-allpos-alldep.dep

SIG=`date '+%Y-%m-%d-%H%M%S'`-unlabeled-allpos-alldep
