...
TRAIN_IN=${ROOT}/data/input/train-nopos-alldep.dep

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-nopos-alldep.dep

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-nopos-alldep.dep

SIG=`date '+%Y-%m-%d-%H%M%S'`-unlabeled-nopos-alldep
