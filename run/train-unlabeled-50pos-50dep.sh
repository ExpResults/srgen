...
TRAIN_IN=${ROOT}/data/input/train-50pos-50dep.dep

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-50pos-50dep.dep

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-50pos-50dep.dep

SIG=`date '+%Y-%m-%d-%H%M%S'`-unlabeled-50pos-50dep
