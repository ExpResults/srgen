...
TRAIN_IN=${ROOT}/data/input/train-allpos-50dep.depl

TEST_TOK=${ROOT}/data/test/testr.tok
TEST_IN=${ROOT}/data/input/test-allpos-50dep.depl

DEV_TOK=${ROOT}/data/dev/devr.tok
DEV_IN=${ROOT}/data/input/dev-allpos-50dep.depl

SIG=`date '+%Y-%m-%d-%H%M%S'`-labeled-allpos-50dep
